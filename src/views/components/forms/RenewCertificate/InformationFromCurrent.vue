    ...
    <form @submit.prevent="sendData" class="py-5 md:w-2/3">
        <div class="flex flex-col gap-2 mb-5">
            ...
            <div class="text-red border-l-2 border-red px-2 mb-5">
             <b>NOTE: Provide your full name exactly as it is printed on the certificate or declaration.</b>
        </div>
      ...
      <label for="given_name" class="flex flex-col gap-2 mb-5">
        ...
        <!--------------------------Countries  ------------------------------>
         <label for="country" class="flex flex-col gap-2 mb-5">
          ...
          <label for="d_number" class="flex flex-col gap-2 mb-5">
        ...
        <div class="flex flex-col gap-2 mb-5">
            ...
            <h3 class="font-bold text-red border-l-2 border-red px-2 mb-5">
                NOTE: Provide information about who issued your last certificate or declaration along with the date it was issued.
            </h3>
        </div>
