...
<template>
  <section class="">
    <div class="" v-if="tab === 'interpreter-fullname'">
      ...
      <form @submit.prevent="emit('update-tab', 'interpreter-mailing')" class="py-5 md:w-2/3">
    ...
    <div class="" v-else-if="tab === 'interpreter-mailing'">
      ...
      <form @submit.prevent="emit('update-tab', 'interpreter-contact')" class="py-5 md:w-2/3">
    ...
    <div class="" v-else-if="tab === 'interpreter-contact'">
      ...
      <form @submit.prevent="emit('update-tab', 'interpreter-certification')" class="py-5 md:w-2/3">
    ...
    <div class="" v-else-if="tab === 'interpreter-certification'">
      <h2 class="border-b font-bold text-2xl text-primary pb-2">Interpreter's Contact</h2>
      <form @submit.prevent="emit('update-tab', 'interpreter-signature')" class="py-5 md:w-2/3">
        ...
        <input
          ...
          required
        />
        which is the same language provided in tis application, and I have read to this
