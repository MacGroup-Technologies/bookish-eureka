...
import InformationFromCertificate from './forms/RenewCertificate/InformationFromCurrent.vue'
import InformationAboutYou from './forms/RenewCertificate/CurrentInformationAboutYou.vue'
import ApplicationType from './forms/RenewCertificate/ApplicationType.vue'
import ClericalError from './forms/RenewCertificate/CLericalError.vue'
...
const component = computed(() => {
  switch (accordion.value) {
    case 1:
      return InformationFromCertificate
    case 2:
      return InformationAboutYou
    case 3:
      return ApplicationType
    case 4:
      return ClericalError
    case 5:
      return NameChange
    case 6:
      return ChangeofDOB
    ...
    case 9:
      return ContactInfoCertification
    case 10:
      return InterpretersContact
    default:
      return ''
  }
})
    ...
    <div class="flex items-start md:h-[80vh] overflow-auto" v-if="isEmpty(downloadUrl)">
      <div class="hidden md:block md:w-1/4">
        ...
        <div
          ...
          @click="accordion = 1"
        >
          Current Certificate or Declaration
          <svg
            width="30"
            height="31"
            viewBox="0 0 30 31"
